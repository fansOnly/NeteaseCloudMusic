...
interface artistParam extends BaseListParam {
  id: string;
}
...
// 歌手专辑
export const artistAlbum = (params: artistParam, limit: number = 30, offset: number = 0) => get('/artist/album', { limit, offset, ...params })
